...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col">
      ...
      >
        {/* Полупрозрачная подложка для читаемости текста поверх фото */}
        <div className="absolute inset-0 bg-gradient-to-b from-mint/70 via-mint/50 to-mint/70" />
        <div className="relative z-10 mx-auto max-w-2xl">
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight text-white drop-shadow-sm sm:text-5xl md:text-6xl">
            Питайтесь правильно,
            <br />
            живите здорово!
          </h1>
          <p className="mx-auto mt-6 max-w-md text-lg font-medium text-white/95 drop-shadow-sm sm:text-xl">
